...
fn setup_midgame_7x6() -> StdGame {
    ...
    for _ in 0..10 {
        ...
        let mv = moves
            .choose(&mut rng)
            .expect("setup_midgame_7x6: legal moves must not be empty");
        game.make_move(mv);
    }
    game
}
...
fn setup_midgame_9x9() -> Game9x9 {
    ...
    for _ in 0..10 {
        ...
        let mv = moves
            .choose(&mut rng)
            .expect("setup_midgame_9x9: legal moves must not be empty");
        game.make_move(mv);
    }
    game
}
...
fn setup_midgame_19x19() -> Game19x19 {
    ...
    for _ in 0..10 {
        ...
        let mv = moves
            .choose(&mut rng)
            .expect("setup_midgame_19x19: legal moves must not be empty");
        game.make_move(mv);
    }
    game
}
